    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        if (!_supabaseService.isAuthenticated && !_devMode) {
          ...
          // Show error dialog for authentication issue
          showDialog(
            context: context,
            builder: (context) => AlertDialog(
              title: const Text('Authentication Required'),
              content: const Text('You must be logged in to post a service.'),
              actions: [
                TextButton(
        ...
        final userId = _supabaseService.currentUserId ?? "a4fa3b69-5cec-4dde-999f-8cf5bc67cf4a";
        ...
        if (createdJob != null || _devMode) {
              ...
              actions: [
                TextButton(
                  onPressed: () {
                    ...
                    Navigator.pop(context, true); // Close screen if needed
                  },
                  child: const Text('OK'),
                ),
              ],
          ...
          // Show error modal dialog if posting failed
          showDialog(
            context: context,
            builder: (context) => AlertDialog(
              title: const Text('Error'),
              content: const Text('Failed to post service. Please try again.'),
              actions: [
                TextButton(
                  onPressed: () => Navigator.of(context).pop(),
                  child: const Text('OK'),
